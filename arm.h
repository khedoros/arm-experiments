...
uint32_t instr_mask[] = {0x0E000000,
                        0x0FFFFFF0,
                        0x0F000000,
                        0x0E000010,
                        0x0E000010,
...
uint32_t instr_match[] = {0x0A000000,
                        0x012FFF10,
                        0x0F000000,
                        0x06000010,
                        0x00000000,
...
char instr_names[][40] = {"B, BL", 
                          "BX", 
                          "SWI", 
                          "Undefined", 
                          "ALU, shift reg by immediate", 
                          "ALU, shift reg by reg", 
                          "ALU, shift immed by immed", 
                          "Multiply", 
                          "Multiply Long", 
                          "MSR", 
                          "MRS", 
                          ...
                          "LDR, STR immediate",
                          "LDR, STR reg",
                          "LDRH, STRH, LDRSB, LDRSH reg",
                          "LDRH, STRH, LDRSB, LDRSH immed",
                          "SWP",
                          "LDM, STM"};
union instr {
    struct {
